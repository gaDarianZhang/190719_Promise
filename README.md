...
## [在旧式回调 API 中创建 Promise](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Using_promises#在旧式回调_api_中创建_promise)
...
## [嵌套](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Using_promises#嵌套)
